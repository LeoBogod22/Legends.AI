...
let datalist;
       ...
       <div className="info-row d-flex align-items-center w-100">
                    <div className="icon border-secondary d-inline-block" style={{backgroundImage: 'url("http://ddragon.leagueoflegends.com/cdn/6.24.1/img/profileicon/{data.profileIconId} + ".png")'}}>&nbsp;</div>
